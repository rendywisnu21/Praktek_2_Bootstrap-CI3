<!-- File ini berisi form validation -->
<!-- Form Validation berfungsi untuk menginput suatu data -->
<!-- Kita dapat mengaksesnya ke http://localhost/Praktek_2_Bootstrap-CI3/index.php/form -->
