...
<!-- File ini akan dikontrol atau dibuka oleh file controller yang bernama c_helper.php -->
<!-- Kita dapat mengaksesnya ke http://localhost/Praktek_2_Bootstrap-CI3/index.php/c_helper -->
<!DOCTYPE html>
<html>
<head>
